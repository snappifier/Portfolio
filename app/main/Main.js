			...
			<div className="w-full h-dvh flex items-center justify-center bg-zinc-950">
				...
				>
					...
					<motion.div className="w-full h-full flex items-center justify-center"
					            ...
					            transition={{duration: 5, ease: "easeInOut", repeat: Infinity, repeatType: "mirror", delay: 2}}
					>
						<div className="h-full w-1/2 bg-[conic-gradient(from_90deg_at_50%_70%,_#F8F8F8_0%,_#000_0%,#09090b_10%,_#0ea5e9_96%,_#75d4ff_99%)]  "></div>
						<div className="h-full w-1/2 bg-[conic-gradient(from_90deg_at_50%_70%,_#F8F8F8_0%,_#000_0%,#09090b_10%,_#0ea5e9_96%,_#75d4ff_99%)] scale-x-[-1]"></div>
				...
				>
					<motion.div className="w-max h-max flex flex-col items-center justify-center"
											initial={{opacity: 0}}
					            animate={{opacity: 1}}
