								...
								<div className="flex items-center justify-between mb-6">
									<motion.div className="flex items-center" layout>
										<AnimatePresence initial={false}>
											{showForm && (
												<motion.div className="overflow-hidden flex items-center -ml-2"
																		initial={{width: 0, opacity: 0, marginRight: 0}}
																		animate={{width: "auto", opacity: 1, marginRight: 12}}
																		exit={{width: 0, opacity: 0, marginRight: 0}}
																		transition={{duration: 0.25, ease: "easeInOut"}}
												>
													<motion.button className="text-zinc-500 hover:text-white transition-colors duration-300 p-1 rounded-full hover:bg-zinc-700/50 block"
									...
									<motion.button className="text-zinc-500 hover:text-white transition-colors duration-300 p-1 rounded-full hover:bg-zinc-800/50"
									               onClick={handleClose}
									               whileTap={{scale: 0.9}}
									               transition={{duration: 0.1}}
									>
								...
								<AnimatePresence mode="wait" initial={false}>
									{showForm ? (
										...
										<motion.div className="flex flex-col gap-3"
																...
																transition={{duration: 0.25, ease: "easeInOut"}}
										>
											<motion.div className="relative w-full p-6 rounded-xl bg-zinc-800 border border-zinc-700 hover:bg-zinc-700 hover:border-zinc-600 cursor-pointer group overflow-hidden transition-colors duration-300"
											...
											>
												...
												<div className="flex items-center gap-4 relative z-10">
													<div className="w-12 h-12 rounded-full bg-zinc-900 flex items-center justify-center text-zinc-400 group-hover:text-white group-hover:scale-110 transition-all duration-300 shrink-0 border border-zinc-800">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/></svg>
													</div>
													<div>
														<h3 className="text-lg font-semibold text-white">Start a conversation</h3>
														<p className="text-zinc-400 text-sm mt-0.5 group-hover:text-zinc-300 transition-colors duration-300">I usually respond within 24 hours.</p>
													</div>
												</div>
											</motion.div>
