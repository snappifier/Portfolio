	...
	return (
				<div className="w-full mt-12 sm:mt-16 lg:mt-24 mb-15 sm:mb-20 lg:mb-30">
					<div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-20">
						...
						<motion.div className="relative w-[280px] sm:w-[340px] lg:w-[400px] aspect-square flex-shrink-0"
						            initial={{opacity: 0, scale: 0.9}}
						            whileInView={{opacity: 1, scale: 1}}
						            viewport={{once: true, amount: 0.5}}
						            transition={{duration: 0.8}}
						>
							<div className="absolute -inset-4 bg-gradient-to-br from-blue-600/40 to-cyan-500/40 rounded-3xl blur-xl sm:blur-2xl opacity-60" />
							...
							<div className="relative w-full h-full rounded-2xl overflow-hidden bg-zinc-900/50 border border-zinc-700/30 shadow-2xl backdrop-blur-sm group">
								...
								<div className="absolute inset-0 bg-gradient-to-t from-zinc-950/50 via-transparent tp-transparent opacity-80" />
							</div>
						</motion.div>
					</div>
				</div>
